      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0`}>
        ...
        <nav className="mt-6 px-6">
          <ul className="space-y-2">
            <li className="mb-4">
              <Link to="/dashboard" className="flex items-center text-gray-700 hover:text-blue-600 p-2 rounded-lg">
            ...
            <li className="mb-4">
              <Link to="/dashboard/products" className="flex items-center text-gray-700 hover:text-blue-600 p-2 rounded-lg">
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                Productos
              </Link>
            </li>
            <li className="mb-4">
              <Link to="/dashboard/insumos" className="flex items-center text-gray-700 hover:text-blue-600 p-2 rounded-lg">
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                Insumos
              </Link>
            </li>
            <li className="mb-4">
              <Link to="/dashboard/businesses" className="flex items-center text-gray-700 hover:text-blue-600 p-2 rounded-lg">
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                Negocios
              </Link>
            </li>
            <li className="mb-4">
              <Link to="/dashboard/pos" className="flex items-center text-gray-700 hover:text-blue-600 p-2 rounded-lg">
            ...
            <li className="mb-4">
              {/* Actualizar el Link para la nueva pantalla de historial de ventas */}
            ...
            <li className="mb-4">
              <Link to="/dashboard/profile" className="flex items-center text-gray-700 hover:text-blue-600 p-2 rounded-lg">
